...
MaterialTabsInkBar::MaterialTabsInkBar(MaterialTabs *parent)
...
MaterialTabsInkBar::~MaterialTabsInkBar()
{
}

void MaterialTabsInkBar::refreshGeometry()
{
...
void MaterialTabsInkBar::animate()
{
    raise();
...
bool MaterialTabsInkBar::eventFilter(QObject *obj, QEvent *event)
{
    switch (event->type())
    {
    case QEvent::Move:
...
void MaterialTabsInkBar::paintEvent(QPaintEvent*)
{
